...
print(ind_nesima_aparicion([-1, 1, 1, 5, -7, 1, 3],3,1))
...
def frecuencia_posiciones_por_caballo(caballos: list[str], carreras: dict[str, list[str]]):
    res: dict = {}
    lista_pos = [0]*len(caballos)
    cont: int = 0
...
def matriz_capicua (m: list[list[int]]):
    es_capicua:bool = True
    mz_temp: list = []
